class BathroomMedium extends Phaser.Scene{
    ...
    selectAnswer(selected) {
        ...
        if (isCorrect) {
            ...
            this.recordResponse(sessionUser, this.currentQuestionIndex, 1, "ProbabilityMedium");
            ...
            let sessionUser = sessionStorage.getItem("username");
            this.recordResponse(sessionUser, this.currentQuestionIndex, 0, "ProbabilityMedium");
