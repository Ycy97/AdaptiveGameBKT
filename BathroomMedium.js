class BathroomMedium extends Phaser.Scene{
    ...
    constructor(){
        ...
        this.currentClueMessage = "Check out the rubber ducky"
        this.consecutiveWrongAttempts = 0;

        this.hints = {
            1: 'There is something on the mirror',
            2: 'Maybe the clue lies in one of the toilet rolls',
            3: 'Check out the basket',
            4: 'Its all bones',
            5: 'A vendor machine that needs to be restocked...?',
            6: 'Get the syringe!',
            7: 'Pink fluffy in the kid section',
    ...
    create(){
        ...
        const layoutLayer = map.createLayer('Layout', [bathroomTiles, doorTiles, roombuilderTiles,hospitalTiles,classroomTiles]);
        const furnitureLayer = map.createLayer('Furnitures', [bathroomTiles, doorTiles, roombuilderTiles,hospitalTiles,classroomTiles]);
        const miscLayer = map.createLayer('Misc', [bathroomTiles, doorTiles, roombuilderTiles,hospitalTiles,classroomTiles]);
    ...
    selectAnswer(selected) {
        ...
        if (isCorrect) {
            ...
            this.recordResponse(sessionUser, this.currentQuestionIndex, 1, "ProbabilityMedium", this.knowledge_state, currentTime);
            ...
            let sessionUser = sessionStorage.getItem("username");
            this.recordResponse(sessionUser, this.currentQuestionIndex, 0, "ProbabilityMedium", this.knowledge_state, currentTime);
