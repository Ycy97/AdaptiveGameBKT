class ClassroomMedium extends Phaser.Scene{
    ...
    constructor(){
        ...
        this.hints = {
            ...
            2: 'One of the table contains the question for the next passcode',
    ...
    async fetchQuestions() {
        try {
            const response = await fetch('http://127.0.0.1:5000/numbersMedium');
            if (!response.ok) {
    ...
    selectAnswer(selected) {
        ...
        if (isCorrect) {
            ...
            this.recordResponse(sessionUser, this.currentQuestionIndex, 1, "NumbersMedium", this.knowledge_state, currentTime);
            ...
            let sessionUser = sessionStorage.getItem("username");
            this.recordResponse(sessionUser, this.currentQuestionIndex, 0, "NumbersMedium", this.knowledge_state, currentTime);
