class LoungeHard extends Phaser.Scene{
    ...
    async fetchQuestions() {
        try {
            const response = await fetch('http://127.0.0.1:5000/algebraHard');
            if (!response.ok) {
    ...
    selectAnswer(selected) {
        ...
        if (isCorrect) {
            ...
            this.recordResponse(sessionUser, this.currentQuestionIndex, 1, "AlgebraHard", this.knowledge_state, currentTime);
            ...
            let sessionUser = sessionStorage.getItem("username");
            this.recordResponse(sessionUser, this.currentQuestionIndex, 0, "AlgebraHard", this.knowledge_state, currentTime);
