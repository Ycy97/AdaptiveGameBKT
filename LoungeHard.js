class LoungeHard extends Phaser.Scene{
    ...
    createWelcomeMessage() {
        ...
        const welcomeText = "Welcome to the Third Lounge!\n\n" +
            "Your first clue is: \n" +
            "Check out the globe."
    ...
    selectAnswer(selected) {
        ...
        if (isCorrect) {
            ...
            this.recordResponse(sessionUser, this.currentQuestionIndex, 1, "AlgebraHard");
            ...
            let sessionUser = sessionStorage.getItem("username");
            this.recordResponse(sessionUser, this.currentQuestionIndex, 0, "AlgebraHard");
