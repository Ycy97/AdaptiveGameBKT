...
def chatgpt_prompt():
    ...
    augment =  "Do not provide the direct answers except for formulas. Give me the hints only with simple explanation within 3 sentences for a student. Dont have to bold or italic the response."
